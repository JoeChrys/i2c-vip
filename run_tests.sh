...
xrun top.sv -timescale 1ps/1ps -sysv -access +rw -uvm -seed random -uvmhome CDNS-1.2 +UVM_TESTNAME=i2c_random_test -clean -l i2c_random_test.log +DUMPNAME="i2c_random_test.vcd" +VERBOSITY=UVM_DEBUG -s -input restore.tcl -gui
